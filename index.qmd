...
::: {.callout-tip}
## Key Concept
Variable type determines which statistical methods are valid.
:::
...
::: {.callout-tip}
## Key Concept
Proper sample size planning prevents underpowered studies.
:::
...
::: {.callout-tip}
## Key Concept
Describe your data before testing hypotheses.
:::
...
::: {.callout-tip}
## Key Concept
Different t-tests for different study designs.
:::
...
::: {.callout-tip}
## Key Concept
ANOVA tests for any differences; post-hoc tests identify which groups differ.
:::
...
::: {.callout-tip}
## Key Concept
Multiple testing inflates Type I error; corrections are essential.
:::
...
::: {.callout-tip}
## Key Concept
Non-parametric tests for non-normal data or ordinal variables.
:::
...
::: {.callout-tip}
## Key Concept
Regression models relationships while controlling for confounders.
:::
...
::: {.callout-tip}
## Key Concept
Logistic regression for binary outcomes (success/failure, disease/no disease).
:::
