...
**Package Management**: Install packages once (_install.packages()_), load them each session (_library()_). This page will mainly use the `tidyverse` collection for easy data analysis workflows. 
